package com.bogotravel.bogotravel.maps
...
class MapsFragment : Fragment() {
   ...
   private val args: MapsFragmentArgs by navArgs()
    ...
    private val callback = OnMapReadyCallback { googleMap ->
        ...
        val posPoi = LatLng(poi.latitud, poi.longitud)
        googleMap.addMarker(
                MarkerOptions()
                    .position(posPoi)
                    .title(poi.name)
                    .snippet(poi.valoracion)
        )
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(posPoi, 16F))
